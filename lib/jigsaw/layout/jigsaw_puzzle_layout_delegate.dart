...
import 'package:very_good_slide_puzzle/jigsaw/widgets/widgets.dart';
...
/// {@endtemplate}
class JigSawPuzzleLayoutDelegate extends PuzzleLayoutDelegate {
  ...
  Widget tileBuilder(Tile tile, PuzzleState state) {
    return JigSawPuzzleTile(
      tile: tile as JigSawTile,
      state: state,
    );
  }
