...
/// {@endtemplate}
class JigSawPuzzleBoard extends StatefulWidget {
  /// {@macro dashatar_puzzle_board}
  const JigSawPuzzleBoard({
    Key? key,
    required this.tiles,
  }) : super(key: key);
  ...
  @override
  State<JigSawPuzzleBoard> createState() => _JigSawPuzzleBoardState();
}

class _JigSawPuzzleBoardState extends State<JigSawPuzzleBoard> {
