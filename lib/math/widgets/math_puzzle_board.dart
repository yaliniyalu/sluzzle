...
/// {@endtemplate}
class MathPuzzleBoard extends StatefulWidget {
  /// {@macro dashatar_puzzle_board}
  const MathPuzzleBoard({
    Key? key,
    required this.tiles,
  }) : super(key: key);
  ...
  @override
  State<MathPuzzleBoard> createState() => _MathPuzzleBoardState();
}

class _MathPuzzleBoardState extends State<MathPuzzleBoard> {
    ...
    return BlocListener<PuzzleBloc, PuzzleState>(
      ...
      child: ResponsiveLayoutBuilder(
        small: (_, child) => SizedBox.square(
          key: const Key('math_puzzle_board_small'),
          dimension: _BoardSize.small,
          child: child,
        ),
        medium: (_, child) => SizedBox.square(
          key: const Key('math_puzzle_board_medium'),
          dimension: _BoardSize.medium,
          child: child,
        ),
        large: (_, child) => SizedBox.square(
          key: const Key('math_puzzle_board_large'),
