...
import 'package:very_good_slide_puzzle/pipe/widgets/widgets.dart';
...
/// {@endtemplate}
class PipePuzzleLayoutDelegate extends PuzzleLayoutDelegate {
  ...
  Widget tileBuilder(Tile tile, PuzzleState state) {
    return PipePuzzleTile(
      tile: tile as PipeTile,
      state: state,
    );
  }
